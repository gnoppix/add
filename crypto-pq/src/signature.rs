...
use ml_dsa::{MlDsa87, SigningKey as MlDsaSigningKey, VerifyingKey as MlDsaVerifyingKey, 
             Signature as MlDsaSignature, Signer, Verifier};
...
pub fn sign(data: &[u8], sk: &MlDsa87SigningKey) -> Result<MlDsa87Signature, crate::error::PqError> {
    let sig = sk.sign(data);
    Ok(sig)
}

/// Verify ML-DSA-87 signature
pub fn verify(data: &[u8], sig: &MlDsa87Signature, vk: &MlDsa87VerifyingKey) -> Result<bool, crate::error::PqError> {
