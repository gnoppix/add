...
export default function ThemeToggle() {
  ...
  const effectiveTheme =
    theme === 'system' ? (useThemeStore.getState().systemPrefersDark ? 'dark' : 'light') : theme
      ...
      {isDark ? (
        ...
        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M12 3v1m0 16v1m8.66-11.66l-.71.71M5.04 19.96l-.71-.71M21 12h-1M4 12H3m16.66 11.66l-.71-.71M5.75 5.75l-.71.71M12 7a5 5 0 100 10 5 5 0 000-10z"
          />
        </svg>
      )}
    </button>
